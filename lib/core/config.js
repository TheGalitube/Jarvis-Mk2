...
export function validateRuntimeConfig(config) {
  ...
  if (!plainObject(stt) || !STT_PROVIDERS.has(stt.provider) || typeof stt.fallbackToChrome !== "boolean" || !plainObject(stt.chrome) || !plainObject(stt.nemotron) || !plainObject(stt.whispercpp)) {
...
export function loadRuntimeConfig({ env = process.env, path, overrides } = {}) {
  ...
  const envOverrides = { execution: {}, voice: {}, stt: { chrome: {}, nemotron: {}, whispercpp: {} } };
